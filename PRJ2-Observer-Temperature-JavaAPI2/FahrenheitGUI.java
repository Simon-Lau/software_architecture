...
public class FahrenheitGUI extends JFrame implements Observer{
  ...
  private void setUpScrollPanes() {
   	  ...
   	  lblTempType= new JLabel("Fahrenheit Temperature");
   ...
   public void update(Observable subject, Object arg) {
         ...
         float fTem = tc.getFahrenheitTemperature(option,t);
   	     tempTextArea.setText(""+ fTem);
